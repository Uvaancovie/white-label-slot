...
const strings = {
  en: {
    ...
    bankFreeSpins: "Save Free Spins",
    saveForLater: "Save for Later",
    resumeFreeSpins: "Play Free Spins",
    winBreakdown: "Win Breakdown",
    winningLines: "Winning Lines",
    scatterWinTitle: "Scatter Win",
    footerLegal:
  ...
  zu: {
    ...
    progressiveJackpot: "I-JACKPOT EQPHELELEYO",
    ...
    bankFreeSpins: "Gcina Ama-spin",
    saveForLater: "Gcina kamuva",
    resumeFreeSpins: "Dlala Ama-spin",
    winBreakdown: "Ukuhlukaniswa Kwezinhlamvu",
    winningLines: "Amalayini Anqobile",
    scatterWinTitle: "Ukunqoba kwe-Scatter",
    footerLegal:
